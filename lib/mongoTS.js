...
function simpleMongoTS(options) {
    ...
    var url = options.connectionString;
    var collection = options.collection || 'timeseries';
    ...
    var connect = function () {
        ...
        mongodb.MongoClient.connect(url, function (err, database) {
            if (err) {
                ...
                deferred.resolve(assembleAPI(collection, database));
                setupTTLIndex(database, collection);
            }
        });
...
function assembleAPI(collection, db) {
